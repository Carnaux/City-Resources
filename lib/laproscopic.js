class Laparoscopic{
    constructor(scene, renderer, speed = 0.5, rot = 0.5){
        this.scene = scene;
    ...
    init(){
        ...
        light2.rotation.set(this.degreeToRad(45),0,0);
        ...
        let geometry = new THREE.BoxGeometry( 120, 90, 100 );
        let material = new THREE.MeshPhongMaterial( {color: new THREE.Color("rgb(50,50,50)"), side: THREE.DoubleSide});
